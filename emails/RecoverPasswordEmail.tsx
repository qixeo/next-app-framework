...
export const RecoverPasswordEmail = ({ token }: { token: string }) => (
  <Html>
    <Head />
      ...
      <Container style={container}>
        <Section style={box}>
          ...
          <Button
            ...
            pY={10}
            style={button}
            href={`${baseUrl}/update-password-and-signin/${encodeURIComponent(
              token
            )}`}
          >
            Reset password
          ...
          <Text style={paragraph}>
            If you have trouble you can also copy and paste this link:{' '}
            {`${baseUrl}/update-password-and-signin/${encodeURIComponent(
              token
            )}`}
          </Text>
          <Hr style={hr} />
